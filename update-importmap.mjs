...
const url = `https://demo-micro-frontends.s3-us-west-2.amazonaws.com/%40orgName/demo-micro-frontends-app-team-1/${process.env.TRAVIS_COMMIT}/orgName-demo-micro-frontends-app-team-1.js`;
  ...
  .get(url, res => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = `@orgName/demo-micro-frontends-app-team-1`;
